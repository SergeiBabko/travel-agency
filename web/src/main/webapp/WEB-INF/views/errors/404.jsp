...
<head>
	...
	<title><mytaglib:i18n key="404.pnf" /></title>
</head>
			...
			<div class="content">
				<div class="row">
					<div id="site-layout-example-top" class="col s12">
						<p class="flat-text-logo center white-text caption-uppercase"><mytaglib:i18n key="404.pnf2" /></p>
					</div>
					<div id="site-layout-example-right" class="col s12">
						<div class="row center">
							<h1 class="text-long-shadow col s12 mt-3">404</h1>
							<p class="center white-text"><mytaglib:i18n key="404.msg" /></p>
						</div>
					</div>
				</div>
			</div>
